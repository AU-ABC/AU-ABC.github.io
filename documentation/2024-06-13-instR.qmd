...
Try to install the package `readxl`. You can use the command `install.packages("readxl")` in your RStudio console. Otherwise, go on the bottom right panel and click `Packages` and `Install` like this
...
```{r}
df <- readxl::read_excel("https://github.com/AU-ABC/AU-ABC.github.io/blob/681bb4eda678bc8920cbd9218bebc92e22955093/documentation/2024-06-13-instR/data/example_df1.xlsx")
df
```
