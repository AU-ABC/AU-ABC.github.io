...
The next ABC is on january 16th, in building 1231-114, from 1pm to 3pm. There will be a showcase of local language model and a bulkRNA tutorial by Manuel and Marie. Click the button below for more information and sign up to the event.

&nbsp;

 <p align="center">
  <a href="https://abc.au.dk/news/upcoming/2025-01-16-session11.html" style="background-color: #4266A1; color: #FFFFFF; padding: 30px 20px; text-decoration: none; border-radius: 5px;">
    Information + signup
  </a>
</p>
...
![](img/DDSA.png){widht=500px fig-align="center"}
